...
summary: Four competency areas tracked across four benchmark stages for PhD progress in the Abeshu Hydrosystems Intelligence Group.
---

## How to Use This Rubric

This rubric describes developmental competencies a PhD student in the Abeshu Hydrosystems Intelligence Group may build across four typical stages of the program:
...
| Candidacy | Generates a coherent suite of new, testable questions and hypotheses constituting the dissertation. |
| Defense | Consistently generates new, significant, and testable questions and articulates a vision for further research. |
...
| Candidacy | Designs rigorous analyses including for imaginary hypotheses and results; designs secondary analyses to test robustness. |
| Defense | Independently designs and conducts hypothesis-driven analyses, formally quantifies uncertainty, and tests robustness with secondary analyses. |
...
| Candidacy | Evaluates results critically, recognizes unreliable findings, and designs secondary analyses to test robustness. |
| Defense | Evaluates results critically and independently designs robustness checks. |
...
| Candidacy | Capable of TA support in advanced undergraduate courses in the dissertation area (hydrology, hydroinformatics, water resources). |
| Defense | Capable of TA support in graduate courses in the specific dissertation area. |
...
| Candidacy | Capable of designing and delivering original guest lectures or activities in the dissertation area. |
| Defense | Same as candidacy, with broader range. |
...
| Candidacy | Not yet expected. |
| Defense | Capable of describing in detail the learning goals and structure of a new course. |
...
| Candidacy | Excels in introductory coursework, succeeds in advanced coursework in the dissertation area, and succeeds in introductory coursework in adjacent areas. |
| Defense | Excels in advanced coursework in the dissertation area and succeeds in advanced coursework in adjacent areas. |
...
This rubric is a living document and will be revised as the Abeshu Hydrosystems Intelligence Group grows.
