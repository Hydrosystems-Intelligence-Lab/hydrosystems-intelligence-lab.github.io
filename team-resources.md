...
The lab is just getting started, so some sections are starter guidance rather than mature archive material. As lab projects, software, and training practices grow, this manual should become the place where reusable knowledge gets written down once and improved over time.

## Core Sections

- [About the Lab]({{ '/manual/about/' | relative_url }})
